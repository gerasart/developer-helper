...
"use strict";
eval("\n\nvar _stringify = __webpack_require__(/*! babel-runtime/core-js/json/stringify */ \"./node_modules/babel-runtime/core-js/json/stringify.js\");\n\nvar _stringify2 = _interopRequireDefault(_stringify);\n\nvar _classCallCheck2 = __webpack_require__(/*! babel-runtime/helpers/classCallCheck */ \"./node_modules/babel-runtime/helpers/classCallCheck.js\");\n\nvar _classCallCheck3 = _interopRequireDefault(_classCallCheck2);\n\nvar _createClass2 = __webpack_require__(/*! babel-runtime/helpers/createClass */ \"./node_modules/babel-runtime/helpers/createClass.js\");\n\nvar _createClass3 = _interopRequireDefault(_createClass2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar clickAjax = function () {\n    function clickAjax() {\n        (0, _classCallCheck3.default)(this, clickAjax);\n\n        this.$ = jQuery;\n\n        this.input = false;\n        this.fields = false;\n        this.result = false;\n        this.setEvent();\n    }\n\n    (0, _createClass3.default)(clickAjax, [{\n        key: 'setEvent',\n        value: function setEvent() {\n            var _this = this;\n\n            this.$(document).on('click', '[data-ajax]', function (e) {\n                return _this.sendAjax(e);\n            });\n        }\n    }, {\n        key: 'sendAjax',\n        value: function sendAjax(e) {\n            var _this2 = this;\n\n            this.$but = this.$(e.target);\n            this.action = this.$but.data('ajax');\n\n            ['input', 'result', 'fields'].forEach(function (item) {\n                var selector = _this2.$but.data(item);\n\n                _this2[item] = _this2.$('[data-id=' + selector + ']');\n            });\n\n            var data = {\n                action: this.action,\n                fields: this.fields.find('input, select').serialize(),\n                input: this.input.val()\n            };\n\n            /* global ajaxurl */\n            this.$.post(ajaxurl, data, function (response) {\n                console.log(response);\n                window.logger.log((0, _stringify2.default)(response));\n                if (_this2.result) {\n                    _this2.result.html(response);\n\n                    if (response.success) {\n                        _this2.printResult(response.data);\n                    }\n                }\n            });\n        }\n    }, {\n        key: 'printResult',\n        value: function printResult(data) {\n            this.result.html('');\n\n            for (var key in data) {\n                this.result.append(key + \": \");\n\n                if (typeof data[key] === 'string') {\n                    this.result.append(data[key]);\n                } else {\n                    this.result.append(data[key].join(','));\n                }\n\n                this.result.append(\"\\n\");\n            }\n        }\n    }]);\n    return clickAjax;\n}();\n\nnew clickAjax();\n\n//# sourceURL=webpack:///./inc/js/classes/clickAjax.js?");

/***/ }),

/***/ "./inc/js/helper/notification-logger.js":
/*!**********************************************!*\
  !*** ./inc/js/helper/notification-logger.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\n__webpack_require__(/*! ../helper/notification-logger */ \"./inc/js/helper/notification-logger.js\");\n\n__webpack_require__(/*! ../classes/clickAjax */ \"./inc/js/classes/clickAjax.js\");\n\n//# sourceURL=webpack:///./inc/js/src/admin-scripts.js?");
